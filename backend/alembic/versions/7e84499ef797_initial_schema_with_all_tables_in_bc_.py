"""Initial schema with all tables in sred_ds
...
def upgrade() -> None:
    # Create sred_ds schema
    op.execute('CREATE SCHEMA IF NOT EXISTS sred_ds')
    ...
    sa.ForeignKeyConstraint(['company_id'], ['sred_ds.companies.id'], ),
    sa.ForeignKeyConstraint(['created_by'], ['sred_ds.users.id'], ),
    sa.ForeignKeyConstraint(['lead_attorney_user_id'], ['sred_ds.users.id'], ),
    sa.ForeignKeyConstraint(['updated_by'], ['sred_ds.users.id'], ),
    sa.PrimaryKeyConstraint('id'),
    schema='sred_ds'
    )
    ...
    op.create_index(op.f('ix_sred_ds_password_reset_tokens_token_hash'), 'password_reset_tokens', ['token_hash'], unique=True, schema='sred_ds')
    ...
    op.create_index(op.f('ix_sred_ds_refresh_tokens_token_hash'), 'refresh_tokens', ['token_hash'], unique=True, schema='sred_ds')
    op.create_table('user_groups',
    sa.Column('user_id', sa.UUID(), nullable=False),
    sa.Column('group_id', sa.UUID(), nullable=False),
    sa.Column('assigned_by', sa.UUID(), nullable=True),
    sa.Column('assigned_at', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=True),
    sa.ForeignKeyConstraint(['assigned_by'], ['sred_ds.users.id'], ),
    sa.ForeignKeyConstraint(['group_id'], ['sred_ds.groups.id'], ),
    sa.ForeignKeyConstraint(['user_id'], ['sred_ds.users.id'], ),
    ...
    sa.Column('updated_at', sa.DateTime(timezone=True), nullable=True),
    sa.Column('updated_by', sa.UUID(), nullable=False),
    sa.ForeignKeyConstraint(['assigned_to'], ['sred_ds.users.id'], ),
    sa.ForeignKeyConstraint(['created_by'], ['sred_ds.users.id'], ),
    sa.ForeignKeyConstraint(['matter_id'], ['sred_ds.matters.id'], ),
    sa.ForeignKeyConstraint(['parent_document_id'], ['sred_ds.documents.id'], ),
    sa.ForeignKeyConstraint(['root_document_id'], ['sred_ds.documents.id'], ),
    sa.ForeignKeyConstraint(['updated_by'], ['sred_ds.users.id'], ),
    sa.PrimaryKeyConstraint('id'),
    schema='sred_ds'
    )
    ...
    sa.ForeignKeyConstraint(['granted_by'], ['sred_ds.users.id'], ),
    sa.ForeignKeyConstraint(['matter_id'], ['sred_ds.matters.id'], ),
    sa.ForeignKeyConstraint(['user_id'], ['sred_ds.users.id'], ),
    sa.PrimaryKeyConstraint('id'),
    schema='sred_ds'
    ...
    sa.Column('created_at', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=True),
    sa.ForeignKeyConstraint(['document_id'], ['sred_ds.documents.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id'),
    schema='sred_ds'
    )
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_table('messages', schema='sred_ds')
    op.drop_table('document_chunks', schema='sred_ds')
    op.drop_table('matter_access', schema='sred_ds')
    op.drop_table('documents', schema='sred_ds')
    op.drop_table('conversations', schema='sred_ds')
    op.drop_table('user_groups', schema='sred_ds')
    op.drop_index(op.f('ix_sred_ds_refresh_tokens_token_hash'), table_name='refresh_tokens', schema='sred_ds')
    op.drop_table('refresh_tokens', schema='sred_ds')
    op.drop_index(op.f('ix_sred_ds_password_reset_tokens_token_hash'), table_name='password_reset_tokens', schema='sred_ds')
    op.drop_table('password_reset_tokens', schema='sred_ds')
    op.drop_table('matters', schema='sred_ds')
    op.drop_table('users', schema='sred_ds')
    op.drop_table('groups', schema='sred_ds')
    op.drop_table('companies', schema='sred_ds')
    # ### end Alembic commands ###

    # Drop sred_ds schema
    op.execute('DROP SCHEMA IF EXISTS sred_ds CASCADE')