...
def upgrade() -> None:
    ...
    sa.Column('usage_documents_count', sa.Integer(), server_default='0', nullable=False),
    sa.Column('usage_storage_bytes', sa.BigInteger(), server_default='0', nullable=False),
    sa.Column('usage_ai_queries_count', sa.Integer(), server_default='0', nullable=False),
    sa.Column('usage_embeddings_count', sa.Integer(), server_default='0', nullable=False),
    ...
    op.create_index(op.f('ix_bc_legal_ds_waitlist_signups_email'), 'waitlist_signups', ['email'], unique=True, schema='bc_legal_ds')
    ...
    op.create_table('billable_sessions',
    sa.Column('id', sa.UUID(), nullable=False),
    sa.Column('company_id', sa.UUID(), nullable=False),
    sa.Column('user_id', sa.UUID(), nullable=False),
    ...
    sa.Column('raw_date_text', sa.String(length=255), nullable=True),
    ...
    sa.ForeignKeyConstraint(['chunk_id'], ['bc_legal_ds.document_chunks.id'], ondelete='SET NULL'),
    sa.ForeignKeyConstraint(['company_id'], ['bc_legal_ds.companies.id'], ),
    sa.ForeignKeyConstraint(['created_by'], ['bc_legal_ds.users.id'], ),
    sa.ForeignKeyConstraint(['document_id'], ['bc_legal_ds.documents.id'], ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['matter_id'], ['bc_legal_ds.matters.id'], ),
    ...
    # Create plan_limits table (not a SQLAlchemy model, so not auto-detected)
    op.create_table(
        'plan_limits',
    ...
    # Create GIN index for hybrid search
    op.create_index(
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    # Drop GIN index and plan_limits first (created last)
    op.drop_index('idx_document_chunks_search_vector', table_name='document_chunks', schema='bc_legal_ds')
    op.drop_table('plan_limits', schema='bc_legal_ds')

    op.drop_table('document_events', schema='bc_legal_ds')
    ...
    op.drop_index(op.f('ix_bc_legal_ds_waitlist_signups_email'), table_name='waitlist_signups', schema='bc_legal_ds')
